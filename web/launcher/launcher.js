(function () {
  ...
  function setupScrollbarFlash() {
    ...
    document.querySelectorAll(".log, .modal-card, .settings-scroll, .toolbox-content, .toolbox-chain-list, textarea").forEach((el) => bind(el, el));
  }

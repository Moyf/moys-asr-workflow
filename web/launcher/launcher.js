(function () {
  ...
  Object.assign(STRINGS.zh, {
    ...
    custom_asr_model_placeholder: "例如 whisper-1",
  ...
  Object.assign(STRINGS.en, {
    ...
    custom_asr_model_placeholder: "For example, whisper-1",
  ...
  Object.assign(STRINGS.zh, {
    toolbox_prompt_template: "提示词模板", toolbox_prompt_template_choose: "选择已保存模板", toolbox_prompt_template_name_placeholder: "模板名称，例如：品牌宣传英文", toolbox_prompt_template_save: "保存模板", toolbox_prompt_template_delete: "删除", toolbox_prompt_template_need_name: "请先填写模板名称。", toolbox_prompt_template_need_text: "请先填写自定义提示词。", toolbox_prompt_template_saved: "提示词模板已保存。", toolbox_prompt_template_deleted: "提示词模板已删除。", toolbox_prompt_template_select: "请先选择要删除的模板。", toolbox_output_name: "输出名称", toolbox_output_name_placeholder: "可选；留空使用默认命名"
  });
  Object.assign(STRINGS.en, {
    toolbox_prompt_template: "Prompt templates", toolbox_prompt_template_choose: "Choose a saved template", toolbox_prompt_template_name_placeholder: "Template name, e.g. Brand English", toolbox_prompt_template_save: "Save template", toolbox_prompt_template_delete: "Delete", toolbox_prompt_template_need_name: "Enter a template name first.", toolbox_prompt_template_need_text: "Enter a custom prompt first.", toolbox_prompt_template_saved: "Prompt template saved.", toolbox_prompt_template_deleted: "Prompt template deleted.", toolbox_prompt_template_select: "Choose a template to delete first.", toolbox_output_name: "Output name", toolbox_output_name_placeholder: "Optional; leave blank for the default name"
  });
  Object.assign(STRINGS.zh, {
  ...
  window.MAWLauncher = { backend: "pending", config: null, callBackend: bridge, translate: t, errorText: errText, viewportPixelsToPage, openSettings, closeSettings, setJsonPath, openServerEditor, getTranscriptionPayload: formPayload, appendLog, confirm: confirmAction, confirmResolve: null, onBackendEvent: handleBackendEvent, onBackendEvents(events) { events.forEach(handleBackendEvent); }, onBatchStart: hideErrorNotice, onBatchError: (result) => applyErrorResult(result, false), onLanguageChanged() {}, onProjectPathChanged() {}, onMediaPathChanged() {} };

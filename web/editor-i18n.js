(function initMaweI18n(global) {
  ...
  const EN_ATTR = {
    ...
    '导出原视频/音频的去空隙 EDL 时间线，保留源媒体入出点并压缩移除的空隙': 'Export a gap-removed EDL timeline for the original video/audio, preserving source in/out points while packing removed gaps',
    '时间线 EDL': 'Timeline EDL',
    '去空隙 EDL 时间线文件': 'Gap-removed EDL timeline file',
    '无法获得媒体文件名；请先加载媒体后再导出 EDL': 'The media filename is unavailable; load media before exporting EDL',
    '去空隙 EDL 导出失败': 'Gap-removed EDL export failed',

(function initMaweI18n(global) {
  ...
  const EN_TEXT = {
    ...
    '颜色样式': 'Color style', '预览字幕颜色样式': 'Subtitle color preview style',
    ...
    '当前预览样式由': 'Current preview styling is controlled by',
    '控制': 'controls',
    ...
    '替换当前字幕': 'Replace current subtitles', '作为双语字幕': 'Add as bilingual subtitles', '导入': 'Import',

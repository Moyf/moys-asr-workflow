...
- **多方案文稿粗剪** ：编辑器可按主字幕整句标记视频取舍，或导入同时间轴 SRT 安全匹配删除、改字、合并与存疑内容；一个母工程可保存多套独立方案，支持预览、单独导出或批量导出粗剪 MP4 与匹配 SRT。旧版单方案工程会自动迁移。

## [1.5.0] - 2026-08-29

> 正式版草稿：以下条目由 1.5.0-beta.10 至 1.5.0-beta.1 汇总复制而来，请在正式发布前手工去重、调整和确认。

...
class EditorAssetTests(unittest.TestCase):
    ...
    def test_blank_editor_inlines_modular_assets(self) -> None:
        ...
        self.assertIn('mediaSeekStepMs: clampEditorMediaSeekStepMs(savedMediaSeekStepMs)', page)
        ...
        self.assertIn('cueListAutoScrollOnClick: source.cueListAutoScrollOnClick !== false', page)
        ...
        self.assertIn('cueListShowIndex: source.cueListShowIndex !== false', page)
        self.assertIn('cueListShowTime: source.cueListShowTime !== false', page)
        self.assertIn('cueListShowSticker: source.cueListShowSticker !== false', page)
        self.assertIn('cueListShowCharcount: source.cueListShowCharcount !== false', page)
        self.assertNotIn('id="cue-editor-show-navigation" checked', page)
        self.assertNotIn('id="cue-editor-show-time-actions" checked', page)
        self.assertIn('cueEditorShowTimeActions: source.cueEditorShowTimeActions === true', page)
        self.assertIn('id="cue-editor-show-sticker"> 表情包', page)
        self.assertIn('cueEditorShowNavigation: source.cueEditorShowNavigation === true', page)
        self.assertIn('cueEditorShowSticker: source.cueEditorShowSticker === true', page)

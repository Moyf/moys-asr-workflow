...
class GuiWebBridgeTests(unittest.TestCase):
    ...
    def test_get_config_exposes_local_provider_and_runtime_status(self) -> None:
        ...
        self.assertEqual(local["models"][0]["estimatedSize"], "2.5–4.5 GB")
...
class LauncherAssetContractTests(unittest.TestCase):
    ...
    def test_local_runtime_lives_in_settings_runtime_tab_with_advanced_check_link(self) -> None:
        ...
        self.assertIn('status.textContent = ready ? "✓" : t(statusKey);', script)
        ...
        self.assertIn('local_model_badge_segment_timestamps', script)
    ...
    def test_launcher_localizes_backend_config_labels_in_english_mode(self) -> None:
        ...
        self.assertIn('note="轻量多语种识别；原生字/词级时间码；可复用 Qwen3-ForcedAligner"', backend)

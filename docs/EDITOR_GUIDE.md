...
波形中橙色斜纹代表已移除，灰蓝斜纹代表被保留的空隙。`Alt + 点击` 可切换单段状态；在波形空白处右键选择“添加空隙”会从鼠标位置插入一段默认时长的移除区段。选择“拖动边界”或“边界与中键”时可拖动左右边界；选择“中键拖动”或“边界与中键”时可用中键调整范围。`Alt + 拖动` 可整体偏移 Gap，`Ctrl/Cmd + 拖动` 可复制 Gap；更细的范围调整在“空隙操作”设置中启用。
